...
public class EnemyCounter extends Actor
{
     ...
     */
    public EnemyCounter(int enemyNumber, boolean mainCounter,int level){
    ...
    /**
     * Act - do whatever the EnemyCounter wants to do. This method is called whenever
    ...
    public void enemiesEliminated(){
        if(enemyNumber == 0 && !levelCleared && mainCounter){
            levelClear();
            levelCleared = true;            
        }
    }
